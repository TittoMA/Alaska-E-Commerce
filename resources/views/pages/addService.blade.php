...
<div class="container mt-4">
    ...
    <form action="{{ route('myStore.upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-3">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="form-floating mb-3">
                    <input id="service-name" type="text" name="service_name"
                        ...
                        value="{{ old('service_name') }}" placeholder="service_name">
                ...
                <div class="input-group">
                    <button type="submit" class="btn def-button ms-auto">
                        <i class="bi bi-check-circle-fill me-2"></i> Upload
                    </button>
                </div>
            </div>
        </div>
